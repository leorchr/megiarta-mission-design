...
public class PlayerSoundManager : MonoBehaviour
{
    ...
    public void Step()
    {
        if(ambientSoundManager != null && ambientSoundManager.isOnIsland && grassStepSounds.Count != 0)
        {
        ...
        else if(ambientSoundManager != null && !ambientSoundManager.isOnIsland && rockStepSounds.Count != 0)
        {
